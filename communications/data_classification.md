...
* **Personal Information**: Privacy laws typically protect personal information, and include Protected Health Information (PHI) Personally Identifiable Information (PII).
...
* **Slack**: Personal Information should be limited to private channels and direct messages. Information confidential to Lullabot should be kept in Lullabot-only channels and not channels shared with clients or vendors.
